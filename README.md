...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tplot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15079&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tplot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tplot` can be installed with:

```
conda install tplot
```

It is possible to list all of the versions of `tplot` available on your platform with:
